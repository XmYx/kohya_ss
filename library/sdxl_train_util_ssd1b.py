...
from library import model_util, sdxl_model_util, train_util_ssd1b, sdxl_original_unet_ssd1b
...
def load_target_model(args, accelerator, model_version: str, weight_dtype):
    ...
    text_encoder1, text_encoder2, unet = train_util_ssd1b.transform_models_if_DDP([text_encoder1, text_encoder2, unet])
...
def _load_target_model(
    ...
    if load_stable_diffusion_format:
        ...
        try:
            try:
                pipe = StableDiffusionXLPipeline.from_pretrained(
                    name_or_path, torch_dtype=model_dtype, variant=variant, use_safetensors=True, tokenizer=None
                )
        ...
        with init_empty_weights():
            unet = sdxl_original_unet_ssd1b.SdxlUNet2DConditionModel()  # overwrite unet
        sdxl_model_util._load_state_dict_on_device(unet, state_dict, device=device, dtype=model_dtype)
        print("U-Net converted to original SSD-1B U-Net")
...
def save_sd_model_on_train_end(
    ...
    def sd_saver(ckpt_file, epoch_no, global_step):
        sai_metadata = train_util_ssd1b.get_sai_model_spec(None, args, True, False, False, is_stable_diffusion_ckpt=True)
    ...
    train_util_ssd1b.save_sd_model_on_train_end_common(
...
def save_sd_model_on_epoch_end_or_stepwise(
    ...
    train_util_ssd1b.save_sd_model_on_epoch_end_or_stepwise_common(
        args,
        on_epoch_end,
        accelerator,
